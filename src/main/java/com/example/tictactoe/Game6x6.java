    ...
    private boolean checkForWin(){
        ...
        for(int i = 0 ; i<6 ;i++) {
            if      ((field[i][0].equals(field[i][1]) && field[i][0].equals(field[i][2])&& !field[i][0].equals(""))
                    ...
                    ||
                    (field[i][3].equals(field[i][4]) && field[i][3].equals(field[i][5])&& !field[i][3].equals("")))
            {
                return true;
            }
        }
        ...
        for(int i = 0 ; i<6 ;i++) {
            if      (field[0][i].equals(field[1][i]) && field[0][i].equals(field[2][i]) && !field[0][i].equals("")
                    ...
                    ||
                    (field[3][i].equals(field[4][i]) && field[3][i].equals(field[5][i]) && !field[3][i].equals("")))
            {
                return true;
            }
        }
        ...
        if ((field[0][0].equals(field[1][1]) && field[0][0].equals(field[2][2]) && !field[0][0].equals(""))
                ...
                || (field[3][3].equals(field[4][4]) && field[3][3].equals(field[5][5]) && !field[3][3].equals(""))){
            return true;
        }
        ...
        if (field[1][0].equals(field[2][1]) && field[1][0].equals(field[3][2]) && !field[1][0].equals("")
                ...
                ||(field[3][2].equals(field[4][3]) && field[3][2].equals(field[5][4]) && !field[3][2].equals(""))) {
            return true;
        }
        ...
        if (field[0][1].equals(field[1][2]) && field[0][1].equals(field[2][3]) && !field[0][1].equals("")
                ...
                ||(field[2][3].equals(field[3][4]) && field[2][3].equals(field[4][5]) && !field[2][3].equals(""))) {
            return true;
        }
        if ( field[5][0].equals(field[4][1]) && field[5][0].equals(field[3][2]) && !field[5][0].equals("")
                ||(field[4][1].equals(field[3][2]) && field[4][1].equals(field[2][3]) && !field[4][1].equals(""))
                ||(field[3][2].equals(field[2][3]) && field[3][2].equals(field[1][4]) && !field[3][2].equals(""))
                ||(field[2][3].equals(field[1][4]) && field[2][3].equals(field[0][5]) && !field[2][3].equals(""))) {
            return true;
        }
        if (field[2][0].equals(field[3][1]) && field[2][0].equals(field[4][2]) && !field[2][0].equals("")
            ||field[3][1].equals(field[4][2]) && field[3][1].equals(field[5][3]) && !field[3][1].equals("")) {
            return true;
        }
        if (field[0][2].equals(field[1][3]) && field[0][2].equals(field[2][4]) && !field[0][2].equals("")
            ||field[1][3].equals(field[2][4]) && field[1][3].equals(field[3][5]) && !field[1][3].equals("")) {
            return true;
        }
        if (field[1][5].equals(field[2][4]) && field[1][5].equals(field[3][3]) && !field[1][5].equals("")
                ||(field[2][4].equals(field[3][3]) && field[2][4].equals(field[4][2]) && !field[2][4].equals(""))
                ||(field[3][3].equals(field[4][2]) && field[3][3].equals(field[5][1]) && !field[3][3].equals(""))) {
            return true;
        }
        if (field[3][0].equals(field[4][1]) && field[3][0].equals(field[5][2]) && !field[3][0].equals("")) {
            return true;
        }
        if (field[0][3].equals(field[1][4]) && field[0][3].equals(field[2][5]) && !field[0][3].equals("")) {
            return true;
        }
        if (field[2][5].equals(field[3][4]) && field[2][5].equals(field[4][3]) && !field[2][5].equals("")
                ||field[3][4].equals(field[4][3]) && field[3][4].equals(field[5][2]) && !field[3][4].equals("")) {
            return true;
        }
        if (field[3][5].equals(field[4][4]) && field[3][5].equals(field[5][3]) && !field[3][5].equals("")) {
            return true;
        }
        return false;
    }
